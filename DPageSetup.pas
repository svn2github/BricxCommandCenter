...
$Id: DPageSetup.pas,v 1.1.1.1 2009/01/12 02:27:50 jhansen Exp $
...
begin
  ...
  // make sure our internal margins are using the same units as the external margins
  fMargins.UnitSystem := SynEditPrint.Margins.UnitSystem;
...
procedure TPageSetupDlg.EditKeyPress(Sender: TObject; var Key: Char);
begin

...
type
  ...
  private
    ...
    fMaxErrors: Integer;
    fMaxPreprocDepth: Integer;
    fCurFile: string;
    fOldCurFile: string;
    fDirLine : string;
    fCurrentLine : string;
    fWarningsOff: boolean;
    function GetCompilerMessages: TStrings;
    function GetDefines: TStrings;
    function GetIncludeDirs: TStrings;
    procedure SetCurrentFile(const Value: string);
    function GetASMSource: TStrings;
  public
    constructor Create; virtual;
    destructor Destroy; override;
    procedure ParseASM(aStrings : TStrings);
    procedure SaveToStream(aStream : TStream);
    procedure SaveToFile(aFilename : string);
    property CompilerMessages : TStrings read GetCompilerMessages;
    property Defines : TStrings read GetDefines;
    property IncludeDirs : TStrings read GetIncludeDirs;
    property MaxErrors : Integer read fMaxErrors write fMaxErrors;
    property MaxPreprocessorDepth : Integer read fMaxPreprocDepth write fMaxPreprocDepth;
    property CurrentFile : string read fCurFile write SetCurrentFile;
    property WarningsOff : boolean read fWarningsOff write fWarningsOff;
    property ASMSource : TStrings read GetASMSource;
  end;
...
constructor TLsmAssembler.Create;
begin
  inherited;
...
destructor TLsmAssembler.Destroy;
begin
  FreeAndNil(fDefines);
...
function TLsmAssembler.GetASMSource: TStrings;
begin
  Result := fASM;
end;

function TLsmAssembler.GetCompilerMessages: TStrings;
begin
  Result := fMessages;
end;

function TLsmAssembler.GetDefines: TStrings;
begin
  Result := fDefines;
end;

function TLsmAssembler.GetIncludeDirs: TStrings;
begin
  Result := fIncludeDirs;
end;

procedure TLsmAssembler.ParseASM(aStrings: TStrings);
begin

end;

procedure TLsmAssembler.SaveToFile(aFilename: string);
var
  FS : TFileStream;
begin
...
procedure TLsmAssembler.SaveToStream(aStream: TStream);
begin

end;

procedure TLsmAssembler.SetCurrentFile(const Value: string);
begin
  fCurFile := Value;
end;

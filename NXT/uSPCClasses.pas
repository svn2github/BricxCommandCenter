...
begin
  ...
  // remove the '@' which is used by SPC to indicate an absolute numeric address
...
var
  bIsBin, bIsObj : boolean;
  MS, Bin : TMemoryStream;
  SL : TStringList;
  ext : string;
begin
    ...
    begin
      ...
      try
        ...
        begin
          ...
          try
            SProObjToBin(MS, Bin);
            Result := LoadFromBinaryStream(Bin);
          finally
            Bin.Free;
          end;
        end;

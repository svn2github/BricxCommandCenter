...
function SPCStrToType(const stype : string; bUseCase : Boolean = false) : TDSType;
var
  tmptype : string;
begin
  tmptype := stype;
...
procedure TSPCComp.ReportProblem(const lineNo: integer; const fName,
...
procedure TSPCComp.CheckIdent;
begin
  if Token <> TOK_IDENTIFIER then Expected(sIdentifier);
end;

function TSPCComp.ValueIsNumeric: boolean;
var
  vName : string;
  idx : integer;
  V : TVariable;
...
procedure TSPCComp.CheckNumeric;
begin
...
function TSPCComp.IsHex(c: char): boolean;
begin
...
function TSPCComp.IsMulop(c: char): boolean;
begin
  Result := c in ['*', '/', '%'];
end;

function TSPCComp.IsOrop(c: char): boolean;
begin
  Result := c in ['|', '^'];
end;

function TSPCComp.IsRelop(c: char): boolean;
begin
  Result := c in ['=', '!', '<', '>'];
end;

function TSPCComp.IsWhite(c: char): boolean;
begin
  Result := c in [' ', TAB, CR, LF, TOK_BLOCK_COMMENT, TOK_LINE_COMMENT];
end;

procedure TSPCComp.SkipCommentBlock;
begin
  repeat
    repeat
      GetCharX;
...
procedure TSPCComp.SkipDirectiveLine;
begin
  fDirLine := Value + ' ';
  SkipWhite;
  repeat
...
function TSPCComp.GlobalIdx(n: string): integer;
begin
...
function TSPCComp.GlobalTypeName(const n: string): string;
var
  i : integer;
begin
  Result := '';
...
function TSPCComp.IsFuncParam(n: string; bStripInline : boolean): boolean;
var
  i : integer;
...
function TSPCComp.FuncParamDataType(const n: string): char;
var
  i : integer;
  fp : TFunctionParameter;
  decvar : string;
...
function TSPCComp.IsParam(n: string): boolean;
begin
  Result := IsOldParam(n);
  if not Result then
...
function TSPCComp.IsParamConst(n: string): boolean;
var
  i : integer;
begin
  Result := False;
...
function TSPCComp.ParamTypeName(const n: string): string;
var
  i : integer;
begin
  Result := '';
...
function TSPCComp.IsLocal(n: string): boolean;
begin
...
function TSPCComp.LocalIdx(n: string): integer;
var
  i : integer;
begin
  n := RootOf(n);
...
function TSPCComp.IsLocalConst(n: string): boolean;
var
  i : integer;
begin
  Result := False;
...
function TSPCComp.LocalDataType(const n: string): char;
var
  i : integer;
begin
  Result := #0;
...
function TSPCComp.LocalTypeName(const n: string): string;
var
  i : integer;
begin
  Result := '';
...
procedure TSPCComp.CheckTable(const N: string);
begin
...
procedure TSPCComp.CheckGlobal(const N: string);
begin
  if not IsGlobal(N) then
    Undefined(N);
end;

procedure TSPCComp.CheckDup(N: string);
begin
  if IsGlobal(N) then
    Duplicate(N);
end;
...
procedure TSPCComp.GetDirective;
begin
  SkipWhite;
...
procedure TSPCComp.Next(bProcessDirectives : boolean);
begin
  SkipWhite;
...
procedure TSPCComp.MatchString(x: string);
begin
  if Value <> x then Expected('''' + x + '''');
  Next;
end;

procedure TSPCComp.Semi;
begin
  MatchString(TOK_SEMICOLON);
end;

function TSPCComp.NewLabel: string;
var
  S: string;
begin
  S := '';
...
procedure TSPCComp.ClearParams;
begin
  fParams.Clear;
end;

procedure TSPCComp.ClearLocals;
begin
  fLocals.Clear;
  fEmittedLocals.Clear;
end;

procedure TSPCComp.ClearGlobals;
var
  i : integer;
begin
...
function TSPCComp.WhatIs(const n : string) : TSymbolType;
begin
...
function TSPCComp.DataType(const n : string) : char;
var
  p : integer;
  tname : string;
  DE : TDataspaceEntry;
...
function TSPCComp.DataTypeName(const n : string) : string;
begin
  Result := '';
  case WhatIs(n) of
    stParam : begin
...
function TSPCComp.ArrayOfType(dt: char; dimensions : integer): char;
begin
  Result := dt;
...
procedure TSPCComp.CheckNotProc(const Name : string);
begin
  if DataType(Name) in [TOK_PROCEDURE, TOK_TASK] then
    AbortMsg(sAssignTaskError);
end;

procedure TSPCComp.CheckTask(const Name : string);
begin
  if DataType(Name) <> TOK_TASK then
    AbortMsg(sArgMustBeTask);
end;

function TSPCComp.FunctionReturnType(const name : string) : char;
var
  i : integer;
begin
  Result := #0;
...
function TSPCComp.ValueIsArrayType: boolean;
begin
  Result := IsArrayType(DataType(Value));
end;

function TSPCComp.ValueIsUserDefinedType: boolean;
begin
  Result := DataType(Value) = TOK_USERDEFINEDTYPE;
end;

procedure TSPCComp.PopCmpHelper(const cc : TCompareCode);
begin
  CmpHelper(cc, tos, RegisterName);
  pop;
end;

procedure TSPCComp.PopCmpEqual;
begin
  PopCmpHelper(ccEQ);
end;

procedure TSPCComp.PopCmpNEqual;
begin
  PopCmpHelper(ccNEQ);
end;

procedure TSPCComp.PopCmpGreater;
begin
  PopCmpHelper(ccGT);
end;

procedure TSPCComp.PopCmpLess;
begin
  PopCmpHelper(ccLT);
end;

procedure TSPCComp.PopCmpLessOrEqual;
begin
  PopCmpHelper(ccLTEQ);
end;

procedure TSPCComp.PopCmpGreaterOrEqual;
begin
  PopCmpHelper(ccGTEQ);
end;

procedure TSPCComp.NotNumericFactor;
begin
...
function TSPCComp.GetDecoratedIdent(const val : string) : string;
var
  i : integer;
begin
  Result := val;
...
function TSPCComp.GetDecoratedValue : string;
begin
  Result := GetDecoratedIdent(Value);
end;

procedure TSPCComp.NumericRelation;
var
...
procedure TSPCComp.NumericRelationLTGT;
var
  savedToken, savedLook : Char;
begin
...
procedure TSPCComp.CommaExpression;
begin
  BoolExpression;
...
procedure TSPCComp.BoolExpression;
var
  L1, L2 : string;
begin
  CheckForCast;
...
procedure TSPCComp.AddFunctionParameter(pname, varname, tname: string; idx: integer;
  ptype : char; bIsConst, bIsRef, bIsArray : boolean; aDim : integer;
  bHasDefault : boolean; defValue : string);
begin
...
function TSPCComp.FunctionParameterCount(const name : string) : integer;
begin
  Result := fFuncParams.ParamCount(name);
end;

function TSPCComp.FunctionRequiredParameterCount(const name : string) : integer;
begin
  Result := fFuncParams.RequiredParamCount(name);
end;

function TSPCComp.FunctionParameterType(const name: string;
  idx: integer): char;
var
  i : integer;
begin
...
function TSPCComp.FunctionParameterTypeName(const name: string;
  idx: integer): string;
var
  i : integer;
begin
...
function TSPCComp.FunctionParameterIsConstant(const name: string;
  idx: integer): boolean;
var
  i : integer;
begin
...
function TSPCComp.FunctionParameterDefaultValue(const name: string;
  idx: integer): string;
var
  i : integer;
begin
...
function TSPCComp.GetFunctionParam(const procname : string; idx : integer) : TFunctionParameter;
var
  i : integer;
begin
  Result := nil;
...
function TSPCComp.AdvanceToNextParam : string;
begin
  Result := '';
  Next;
...
procedure TSPCComp.DoCall(procname : string);
var
...
function TSPCComp.RemoveArrayDimension(dt: char): char;
begin
  Result := dt;
  if IsArrayType(dt) then
  begin
...
function TSPCComp.AddArrayDimension(dt: char): char;
begin
  case dt of
...
procedure TSPCComp.ArrayAssignment(const name : string; dt : char; bIndexed : boolean);
var
...
procedure TSPCComp.CheckDataType(dt: char);
var
  rhsDT : char;
begin
...
procedure TSPCComp.DoArrayAssignValue(const aName, idx: string; dt: char);
var
  oldType : Char;
...
procedure TSPCComp.DoIf(const lend, lstart : string);
var
  L1, L2: string;
begin
  Next;
...
procedure TSPCComp.DoSwitch(const lstart : string);
var
  L2 : string;
  idx : integer;
begin
...
procedure TSPCComp.DoSwitchCase;
var
  L1 : string;
...
function TSPCComp.SwitchRegisterName: string;
var
  i : integer;
begin
  Result := RegisterName;
...
procedure TSPCComp.FixupSwitch(idx : integer; lbl : string);
var
  i : integer;
  cnt : integer;
  tmpDepth : string;
...
function TSPCComp.SwitchFixupIndex: integer;
begin
  Result := SourceCount;
end;

function TSPCComp.ReplaceTokens(const line: string) : string;
begin
...
procedure TSPCComp.DoAsm(var dt : char);
var
  asmStr : string;
  nestLevel : integer;
begin
...
procedure TSPCComp.DoAPICommands(const lend, lstart : string);
var
  idx : integer;
begin
...
procedure TSPCComp.Statement(const lend, lstart : string);
var
  dt : Char;
begin
...
function TSPCComp.Block(const lend, lstart : string) : boolean;
begin
...
procedure TSPCComp.CheckBytesRead(const oldBytesRead: integer);
begin
...
procedure TSPCComp.BlockStatements(const lend, lstart: string);
var
...
procedure TSPCComp.AllocLocal(const sub, tname : string; dt : char; bConst, bStatic : boolean);
var
  savedval : string;
...
function TSPCComp.GetInitialValue(dt : char): string;
var
  nestLevel : integer;
  tmpExpr : string;
...
procedure TSPCComp.AllocGlobal(const tname : string; dt : char; bInline, bConst, bStatic : boolean);
var
...
function TSPCComp.GetVariableType(vt : char) : char;
begin
  Result := vt;
end;

procedure TSPCComp.TopDecls;
var
  vt : char;
  ...
  tname : string;
begin
  DoCompilerStatusChange(Format(sXXXProcessGlobals, ['SPC']));
  bInline   := False;
  bConst    := False;
  bStatic   := False;
  Scan;
...
procedure TSPCComp.DoLocals(const sub : string);
var
...
function TSPCComp.FormalList(protoexists : boolean; var procname : string) : integer;
var
  protocount : integer;
  pltype : integer;
  pcount : integer;
...
procedure TSPCComp.ProcedureBlock;
var
  Name : string;
...
begin
  ...
  begin
    ...
    CheckIdent;
    Name := Value;
    DoCompilerStatusChange(Format(sXXXProcedure, ['SPC', Name]));
...
var
  protoexists : boolean;
begin
  DoCompilerStatusChange(Format(sXXXFunction, ['SPC', Name]));
  if bInline then
    IncrementInlineDepth;
  if Name = 'main' then
    AbortMsg(sMainMustBeTask);
...
begin
  try
    DoCompilerStatusChange(Format(sXXXCompBegin, ['SPC']));
    ...
    fLHSDataType    := #0;
    fLHSName        := '';
    DoCompilerStatusChange(Format(sXXXPreprocess, ['SPC']));
    PreProcess;
    fMS.Position := 0;
    fParenDepth  := 0;
    DoCompilerStatusChange(Format(sXXXInitProgram, ['SPC']));
    Init;
    DoCompilerStatusChange(Format(sXXXParseProg, ['SPC']));
    Prog;
    DoCompilerStatusChange(Format(sXXXCodeGenComplete, ['SPC']));
  except
    on E : EAbort do
    begin
      fBadProgram := True;
...
procedure TSPCComp.Parse(const aFilename: string);
var
  Stream : TFileStream;
begin
  Clear;
...
procedure TSPCComp.DoBreakContinue(idx : integer; const lbl: string);
var
  val : string;
begin
  val := APIList[idx];
...
procedure TSPCComp.ProcessDirectives(bScan : boolean);
begin
...
procedure TSPCComp.HandlePoundLine;
var
  i : integer;
...
procedure TSPCComp.IncLineNumber;
begin
  linenumber := linenumber + 1;
  inc(totallines);
end;

function TSPCComp.APIFuncNameToID(procname: string): integer;
begin
  Result := StrToIntDef(fAPIFunctions.Values[procname], -1);
end;

function TSPCComp.IsAPIFunc(procname: string): boolean;
begin
  Result := fAPIFunctions.IndexOfName(procname) <> -1;
end;

procedure TSPCComp.AddAPIFunction(const name: string; id: integer);
begin
  fAPIFunctions.Add(name + '=' + IntToStr(id));
end;

function TSPCComp.tos : string;
begin
  Result := fStackVarNames[fStackVarNames.Count - 1];
end;

function TSPCComp.TempSignedLongName: string;
begin
  Result := Format('__tmpslong%s', [fCurrentThreadName]);
end;

function TSPCComp.RegisterName(name : string): string;
begin
  if fUDTOnStack <> '' then
  begin
    Result := fUDTOnStack;
...
procedure TSPCComp.SetDefines(const Value: TStrings);
begin
  fDefines.Assign(Value);
end;

procedure TSPCComp.CheckTypeCompatibility(fp: TFunctionParameter; dt: char; const name : string);
var
...
procedure TSPCComp.CheckNotConstant(const aName: string);
begin
...
function TSPCComp.IsCharLiteral(const aName: string) : boolean;
begin
  Result := (Pos('''', aName) = 1) and (LastDelimiter('''', aName) = Length(aName));
end;

function TSPCComp.CheckConstant(const aName: string) : string;
var
  bIsConst : boolean;
  idx : integer;
  V : TVariable;
...
procedure TSPCComp.DoPreIncOrDec(bPutOnStack : boolean);
var
  bInc : boolean;
begin
  bInc := Token = '+';
...
function TSPCComp.GetPreProcLexerClass: TGenLexerClass;
begin
  Result := TSPCLexer;
end;

procedure TSPCComp.AddTypeNameAlias(const lbl, args: string);
begin
...
function TSPCComp.TranslateTypeName(const name: string): string;
var
  idx : integer;
  tname : string;
begin
...
procedure TSPCComp.ProcessEnum(bGlobal : boolean);
var
  bNewType : boolean;
  ...
  V : TVariable;
begin
  // enums in SPC are unsigned bytes by default
  dt        := TOK_LONGDEF;
  iEnumVal  := 0;
  bNewType  := False;
  sTypeName := '';
...
procedure TSPCComp.ProcessTypedef;
var
...
procedure TSPCComp.CheckForTypedef(var bConst, bStatic, bInline : boolean);
var
  i : integer;
  tmpName : string;
begin
...
function TSPCComp.IsUserDefinedType(const name: string): boolean;
begin
  Result := DataDefinitions.IndexOfName(name) <> -1;
end;

function TSPCComp.DataTypeOfDataspaceEntry(DE: TDataspaceEntry): char;
var
  dim : integer;
  bt : char;
...
procedure TSPCComp.UDTAssignment(const name: string);
begin
  if Token in ['+', '-', '/', '*', '%', '&', '|', '^'] then
  begin
    MathAssignment(name);
...
procedure TSPCComp.GetAndStoreUDT(const name: string);
begin
  NotNumericFactor;
  if fUDTOnStack <> '' then
  begin
...
function TSPCComp.GetUDTType(n: string): string;
var
  i : integer;
...
procedure TSPCComp.OpenParen;
begin
  MatchString(TOK_OPENPAREN);
  inc(fParenDepth);
end;

procedure TSPCComp.EmitInlineParametersAndLocals(func: TInlineFunction);
var
  i : integer;
...
function TSPCComp.TypesAreCompatible(lhs, rhs: char): boolean;
var
  lDim, rDim : integer;
  lBase, rBase : Char;
begin
...
procedure TSPCComp.DecrementNestingLevel;
var
  i : integer;
begin
  dec(fNestingLevel);
...
procedure TSPCComp.CheckEnhancedFirmware;
begin
  if not EnhancedFirmware then
    AbortMsg(sEnhancedFirmwareReqd);
end;

procedure TSPCComp.InitializeGlobalArrays;
begin
...
procedure TSPCComp.CheckForMain;
var
  i : integer;
  V : TVariable;
begin
...
procedure TSPCComp.DoCompilerStatusChange(const Status: string; const bDone : boolean);
begin
  if Assigned(fOnCompilerStatusChange) then
    fOnCompilerStatusChange(Self, Status, bDone);
end;

function TSPCComp.AmInlining: boolean;
begin
  Result := fInlineDepth > 0;
end;

procedure TSPCComp.DecrementInlineDepth;
begin
  // remove the
  dec(fInlineDepth);
end;

procedure TSPCComp.IncrementInlineDepth;
begin
  inc(fInlineDepth);
end;

procedure TSPCComp.HandleSpecialNames;
begin
...
function TSPCComp.GetValueOf(const name: string): string;
begin
  Result := name;
...
procedure TSPCComp.CheckForValidDataType(dt: char);
begin
  // valid data types
...
procedure TSPCComp.HandlePreprocStatusChange(Sender: TObject;
  const StatusMsg: string);
begin
  DoCompilerStatusChange(StatusMsg);
end;

procedure TSPCComp.SetCurFile(const Value: string);
begin
...
function TSPCComp.ProcessArrayDimensions(var lenexpr : string) : string;
var
  bDone, bOpen : boolean;
begin
  lenexpr := '';
...
procedure TSPCComp.CommaStatement(const lend, lstart: string);
begin
...
procedure TSPCComp.CheckAndLoadVar(const Name: string);
begin
  CheckNotProc(Name);
  LoadVar(Name);
end;

procedure TSPCComp.CheckAndStore(const Name: string);
begin
  CheckNotProc(Name);
  Store(Name);
end;

function TSPCComp.CountElements(lenexpr : string) : integer;
var
  expr : string;
  idx, n, dim, i : integer;
...
function TSPCComp.CountValues(ival: string): integer;
var
  SL : TStringList;
begin
...
procedure TSPCComp.Prolog(const name : string; bIsSub : boolean);
begin
  if bIsSub then
  begin
    if AmInlining then
...
procedure TSPCComp.Epilog(bIsSub : boolean);
begin
  if bIsSub then
  begin
    if AmInlining then
...
procedure TSPCComp.EmitStackVariables;
var
  i, j, k : integer;
  f : TInlineFunction;
  name : string;
...
procedure TSPCComp.Allocate(const Name, aVal, Val, tname: string; dt : char; cnt : integer);
begin
...
procedure TSPCComp.InitializeArray(const Name, aVal, Val, tname: string;
...
procedure TSPCComp.EmitGlobalDataInitSubroutine;
var
  i : integer;
  V : TVariable;
  aval : string;
...
procedure TSPCComp.EmitPoundLine;
begin
...
procedure TSPCComp.AcquireVolatile(const aName : string);
begin
...
procedure TSPCComp.ReturnFromRoutine;
begin
  EmitLn('RET');
end;
...
procedure TSPCComp.DoIndex(const aValue, aName, aIndex : string);
var
  tmp, src : string;
begin
  src := aName;
...
procedure TSPCComp.DoIncrement(const aName : string);
begin
  EmitLn(Format('INC %s', [aName]));
end;

procedure TSPCComp.DoDecrement(const aName : string);
begin

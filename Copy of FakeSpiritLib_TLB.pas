...
// *********************************************************************//
  IFakeSpirit = interface(IDispatch)
    ...
    function SCRead(var handle: longword; var count: Smallint; out buffer: PByte1): WordBool; safecall;
    ...
    function SCGetDeviceInfo(out name: WideString; out BTAddress: WideString; 
    ...
    function SCPollCommand(bufNum: Byte; var count: Byte; out aCmd: PByte1): WordBool; safecall;
    function SCWriteIOMap(ModID: LongWord; Offset: Smallint; var count: Smallint; Data: PByte; 
                           chkResponse: WordBool): WordBool; safecall;
    function SCReadIOMap(ModID: LongWord; Offset: Smallint; var count: Smallint; var Data: PByte1): WordBool; safecall;
...
// *********************************************************************//
  IFakeSpiritDisp = dispinterface
    ...
    function DCSetInputMode(Port: Byte; stype: Byte; smode: Byte): WordBool; dispid 226;
    ...
    function SCOpenRead(const filename: WideString; out handle: longword; out size: LongWord): WordBool; dispid 235;
    function SCOpenReadLinear(const filename: WideString; out handle: longword; out size: LongWord): WordBool; dispid 236;
    function SCOpenWrite(const filename: WideString; size: LongWord; out handle: longword): WordBool; dispid 237;
    function SCOpenWriteLinear(const filename: WideString; size: LongWord; out handle: longword): WordBool; dispid 238;
    function SCOpenWriteData(const filename: WideString; size: LongWord; out handle: longword): WordBool; dispid 239;
    function SCOpenAppendData(const filename: WideString; out size: LongWord; out handle: longword): WordBool; dispid 240;
    function SCRead(var handle: longword; var count: Smallint; out buffer: {??PByte1}OleVariant): WordBool; dispid 241;
    function SCWrite(var handle: longword; var buffer: Byte; var count: Smallint; chkResponse: WordBool): WordBool; dispid 242;
    function SCCloseFile(var handle: longword; chkResponse: WordBool): WordBool; dispid 243;
    function SCDeleteFile(var filename: WideString; chkResponse: WordBool): WordBool; dispid 244;
    function SCFindFirstFile(var filename: WideString; out handle: longword; out size: LongWord): WordBool; dispid 245;
    function SCFindNextFile(var handle: longword; out filename: WideString; out size: LongWord): WordBool; dispid 246;
    function SCGetVersions(out protmin: Byte; out protmaj: Byte; out firmmin: Byte; 
                            out firmmaj: Byte): WordBool; dispid 247;
    function SCCloseModuleHandle(var handle: longword; chkResponse: WordBool): WordBool; dispid 248;
    function SCBootCommand(chkResponse: WordBool): WordBool; dispid 249;
    function SCSetBrickName(const name: WideString; chkResponse: WordBool): WordBool; dispid 250;
    function SCGetDeviceInfo(out name: WideString; out BTAddress: WideString; 
                              out BTSignal: LongWord; out FreeMem: LongWord): WordBool; dispid 251;
    function SCDeleteUserFlash(chkResponse: WordBool): WordBool; dispid 252;
    function SCBTFactoryReset(chkResponse: WordBool): WordBool; dispid 253;
    function SCPollCommandLen(bufNum: Byte; out count: Byte): WordBool; dispid 254;
    function SCPollCommand(bufNum: Byte; var count: Byte; out aCmd: {??PByte1}OleVariant): WordBool; dispid 255;
    function SCWriteIOMap(ModID: LongWord; Offset: Smallint; var count: Smallint; var Data: Byte; 
                           chkResponse: WordBool): WordBool; dispid 256;
    function SCReadIOMap(ModID: LongWord; Offset: Smallint; var count: Smallint; 
    ...
    function UploadFile(const filename: WideString; const dir: WideString): WordBool; dispid 261;
    function ListFiles(const searchPattern: WideString; out Files: WideString): WordBool; dispid 262;
    function ListModules(const searchPattern: WideString; out Files: WideString): WordBool; dispid 263;
  end;

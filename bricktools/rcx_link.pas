...
type
  ...
  protected
    ...
    procedure SetTarget(target : byte);
...
//    function  SendFragment(ftype : TRcxFragment; taskNumber : Byte; const data : PByte; length : integer; total : integer = 0) : integer;
    ...
    property  Target : byte read fTarget write SetTarget;
...
function ComputeChecksum(dataSum : Byte; target : byte) : Byte;
begin
...
procedure TRcxLink.SetTarget(target: byte);
begin
  fTarget := target;
  fPredictive := true;

...
begin
  ...
  begin
    ...
    RegisterMethod('Function StartProgram( const filename : string) : boolean');
    RegisterMethod('Function StopProgram : boolean');
    RegisterMethod('Function PlaySoundFile( const filename : string; bLoop : boolean) : boolean');
    ...
    RegisterMethod('Function ResetInputScaledValue( const port : byte) : boolean');
    RegisterMethod('Function ResetOutputPosition( const port : byte; const Relative : boolean) : boolean');
    RegisterMethod('Function MessageWrite( const inbox : byte; const msg : string) : boolean');
    RegisterMethod('Function KeepAlive( var time : cardinal; const chkResponse : boolean) : boolean');
    RegisterMethod('Function LSGetStatus( port : byte; var bytesReady : byte) : boolean');
...
begin
  ...
  begin
    ...
    RegisterVirtualAbstractMethod(TFantomSpirit, @TFantomSpirit.StartProgram, 'StartProgram');
    RegisterVirtualAbstractMethod(TFantomSpirit, @TFantomSpirit.StopProgram, 'StopProgram');
    RegisterVirtualAbstractMethod(TFantomSpirit, @TFantomSpirit.PlaySoundFile, 'PlaySoundFile');
    ...
    RegisterVirtualAbstractMethod(TFantomSpirit, @TFantomSpirit.ResetInputScaledValue, 'ResetInputScaledValue');
    RegisterVirtualAbstractMethod(TFantomSpirit, @TFantomSpirit.ResetOutputPosition, 'ResetOutputPosition');
    RegisterVirtualAbstractMethod(TFantomSpirit, @TFantomSpirit.MessageWrite, 'MessageWrite');
    RegisterVirtualAbstractMethod(TFantomSpirit, @TFantomSpirit.KeepAlive, 'KeepAlive');
    RegisterVirtualAbstractMethod(TFantomSpirit, @TFantomSpirit.LSGetStatus, 'LSGetStatus');

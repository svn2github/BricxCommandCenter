...
begin
  ...
  begin
    FUpButton.Glyph.Handle := LoadBitmap(HInstance, 'USpinUpBtn');
...
begin
  ...
  begin
    FDownButton.Glyph.Handle := LoadBitmap(HInstance, 'USpinDownBtn');
...
procedure TSpinEdit.SetSilentValue(const aValue: LongInt);
var

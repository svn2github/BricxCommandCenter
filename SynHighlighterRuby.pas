...
$Id: SynHighlighterRuby.pas,v 1.1.1.1 2009/01/12 02:34:36 jhansen Exp $
...
procedure TSynRubySyn.SetLine({$IFDEF FPC}const {$ENDIF}NewValue: String; LineNumber:Integer);
begin
...
{$IFDEF SYN_LAZARUS}
procedure TSynRubySyn.GetTokenEx(var TokenStart: PChar;

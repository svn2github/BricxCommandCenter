...
// PASTLWTR : 1.2
// File generated on 8/26/2006 3:28:31 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: E:\nxt\BricxCC\source\FakeSpiritLib.tlb (1)
...
// *********************************************************************//
  IFakeSpirit = interface(IDispatch)
    ...
    function SCWrite(var handle: LongWord; buffer: PByte; var count: Smallint; 
...
// *********************************************************************//
  IFakeSpiritDisp = dispinterface
    ...
    function SCRead(var handle: LongWord; var count: Smallint; out buffer: {??PByte}OleVariant): WordBool; dispid 241;
    function SCWrite(var handle: LongWord; buffer: {??PByte}OleVariant; var count: Smallint; 
                      chkResponse: WordBool): WordBool; dispid 242;
    ...
    function SCGetDeviceInfo(out name: WideString; out BTAddress: Byte; out BTSignal: Byte; 
                              out FreeMem: LongWord): WordBool; dispid 251;
    ...
    function SCPollCommand(bufNum: Byte; var count: Byte; out aCmd: {??PByte}OleVariant): WordBool; dispid 255;
    function SCWriteIOMap(ModID: LongWord; Offset: Smallint; var count: Smallint; Data: {??PByte}OleVariant; 
                           chkResponse: WordBool): WordBool; dispid 256;
    function SCReadIOMap(ModID: LongWord; Offset: Smallint; var count: Smallint; 
                          var Data: {??PByte}OleVariant): WordBool; dispid 257;
    function SCFindFirstModule(var ModName: WideString; out handle: LongWord; out ModID: LongWord; 

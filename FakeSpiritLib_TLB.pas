...
// *********************************************************************//
  IFakeSpirit = interface(IDispatch)
    ...
    function NXTWrite(var handle: LongWord; buffer: PByte; var count: Smallint; 
...
// *********************************************************************//
  IFakeSpiritDisp = dispinterface
    ...
    function NXTRead(var handle: LongWord; var count: Smallint; out buffer: {??PByte}OleVariant): WordBool; dispid 241;
    function NXTWrite(var handle: LongWord; buffer: {??PByte}OleVariant; var count: Smallint; 
    ...
    function NXTPollCommand(bufNum: Byte; var count: Byte; out aCmd: {??PByte}OleVariant): WordBool; dispid 255;
    function NXTWriteIOMap(ModID: LongWord; Offset: Smallint; var count: Smallint; Data: {??PByte}OleVariant; 

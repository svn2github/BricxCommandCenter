...
*)
    ...
    (Kind: ckAPIType; Name: 'PBRMessage'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIType; Name: 'PBRDataBuffer'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIType; Name: 'EEPROMBlock'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIType; Name: 'TPBRFileType'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    ...
    (Kind: ckAPIFunc; Name: 'NXTNameToPBRFileType'; Location: 2; Params: '(name : string)'; Count: 1; Alpha: atNumeric),
    ...
    (Kind: ckAPIFunc; Name: 'LoadKnownPorts'; Location: 2; Params: '(aStrings : TStrings)'; Count: 1; Alpha: atNumeric),
    ...
    (Kind: ckAPIFunc; Name: 'DCStartProgram'; Location: 2; Params: '(const filename : string)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCStopProgram'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCPlaySoundFile'; Location: 2; Params: '(const filename : string; bLoop : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCGetOutputState'; Location: 2; Params: '(const port: byte; var power: integer; var mode: byte; var regmode: byte; var turnratio: integer; var runstate: byte; var tacholimit: cardinal; var tachocount: longint; var blocktachocount: longint; var rotationcount: longint)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCSetOutputState'; Location: 2; Params: '(const port: byte; const power: integer; const mode: byte; const regmode: byte; const turnratio: integer; const runstate: byte; const tacholimit: cardinal)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCGetInputValues'; Location: 2; Params: '(const port: byte; var valid: boolean; var calibrated: boolean; var stype: byte; var smode: byte; var raw: word; var normalized: word; var scaled: smallint; var calvalue: smallint)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCSetInputMode'; Location: 2; Params: '(const port: byte; const stype: byte; const smode: byte)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCSetInputMode'; Location: 2; Params: '(const port: byte; const stype: byte; const smode: byte)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCResetInputScaledValue'; Location: 2; Params: '(const port: byte)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCResetOutputPosition'; Location: 2; Params: '(const port : byte; const Relative : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCMessageWrite'; Location: 2; Params: '(const inbox : byte; const msg : string)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCKeepAlive'; Location: 2; Params: '(var time : cardinal; const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCLSGetStatus'; Location: 2; Params: '(port : byte; var bytesReady : byte; var lsstate : byte)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCGetCurrentProgramName'; Location: 2; Params: '(var name : string)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCGetButtonState'; Location: 2; Params: '(const idx : byte; const reset : boolean; var pressed : boolean; var count : byte)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCMessageRead'; Location: 2; Params: '(const remote: byte; const local: byte; const remove : boolean; var Msg : PBRMessage)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCSetPropDebugging'; Location: 2; Params: '(const debugging : boolean; const pauseClump : byte; const pausePC : Word)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCGetPropDebugging'; Location: 2; Params: '(var debugging : boolean; var pauseClump : byte; var pausePC : Word)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCSetVMState'; Location: 2; Params: '(const state : byte)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCSetVMStateEx'; Location: 2; Params: '(var state : byte; var clump : byte; var pc : word)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DCGetVMState'; Location: 2; Params: '(var state : byte; var clump : byte; var pc : word)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCOpenRead'; Location: 2; Params: '(const filename : string; var handle : FantomHandle; var size : cardinal)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCOpenWrite'; Location: 2; Params: '(const filename : string; const size : cardinal; var handle : FantomHandle)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCRead'; Location: 2; Params: '(var handle : FantomHandle; var count : word; var buffer : PBRDataBuffer)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCWrite'; Location: 2; Params: '(var handle : FantomHandle; const buffer : PBRDataBuffer; var count : word; const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCCloseFile'; Location: 2; Params: '(var handle : FantomHandle; const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCDeleteFile'; Location: 2; Params: '(var filename : string; const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCFindFirstFile'; Location: 2; Params: '(var filename : string; var IterHandle : FantomHandle; var filesize, availsize : cardinal)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCFindNextFile'; Location: 2; Params: '(var IterHandle : FantomHandle; var filename : string; var filesize, availsize : cardinal)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCFindClose'; Location: 2; Params: '(var IterHandle : FantomHandle)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCGetVersions'; Location: 2; Params: '(var protmin: byte; var protmaj: byte; var firmmin: byte; var firmmaj: byte)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCFirmwareVersion'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCInstalledFirmware'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCOpenWriteLinear'; Location: 2; Params: '(const filename : string; const size : cardinal; var handle : FantomHandle)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCOpenReadLinear'; Location: 2; Params: '(const filename : string; var handle : FantomHandle; var size : cardinal)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCOpenWriteData'; Location: 2; Params: '(const filename : string; const size : cardinal; var handle : FantomHandle)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCOpenAppendData'; Location: 2; Params: '(const filename : string; var size : cardinal; var handle : FantomHandle)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCCloseModuleHandle'; Location: 2; Params: '(var handle : FantomHandle; const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCBootCommand'; Location: 2; Params: '(const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCSetBrickName'; Location: 2; Params: '(const name: string; const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCGetBrickName'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCGetDeviceInfo'; Location: 2; Params: '(var name : string; var BTAddress : string; var BTSignal : Cardinal; var memFree : Cardinal)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCFreeMemory'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCDeleteUserFlash'; Location: 2; Params: '(const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCBTFactoryReset'; Location: 2; Params: '(const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCPollCommandLen'; Location: 2; Params: '(const bufNum : byte; var count : byte)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCPollCommand'; Location: 2; Params: '(const bufNum : byte; var count : byte; var buffer : PBRDataBuffer)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCWriteIOMap'; Location: 2; Params: '(var ModID : Cardinal; const Offset : Word; var count : Word; const buffer : PBRDataBuffer; chkResponse : Boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCReadIOMap'; Location: 2; Params: '(var ModID : Cardinal; const Offset : Word; var count : Word; var buffer : PBRDataBuffer)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCFindFirstModule'; Location: 2; Params: '(var ModName : string; var Handle : FantomHandle; var ModID: Cardinal; var ModSize: Cardinal; var IOMapSize : Word)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCFindNextModule'; Location: 2; Params: '(var Handle : FantomHandle; var ModName : string; var ModID: Cardinal; var ModSize: Cardinal; var IOMapSize : Word)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCRenameFile'; Location: 2; Params: '(const old: string; const new: string; const chkResponse : boolean)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DownloadFile'; Location: 2; Params: '(const filename : string; const filetype : TPBRFileType)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'DownloadStream'; Location: 2; Params: '(aStream : TStream; const dest : string; const filetype : TPBRFileType)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'UploadFile'; Location: 2; Params: '(const filename : string; const dir : string)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'UploadFileToStream'; Location: 2; Params: '(const filename : string; aStream : TStream)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'ListFiles'; Location: 2; Params: '(const searchPattern : string; Files : TStrings)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'ListModules'; Location: 2; Params: '(const searchPattern : string; Modules : TStrings)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'ListBricks'; Location: 2; Params: '(Bricks : TStrings)'; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'InitializeResourceNames'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'UpdateResourceNames'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),
    (Kind: ckAPIFunc; Name: 'SCDefragmentFlash'; Location: 2; Params: ''; Count: 1; Alpha: atNumeric),

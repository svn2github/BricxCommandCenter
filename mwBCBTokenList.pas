...
type
  TCTokenKind = (ctkapostrophe, ctk_CHAR_UNSIGNED, ctk_CPPUNWIND, ctk_M_IX86, ctk_WCHAR_T,
    ...
    ctkvoid, ctkvolatile, ctkwchar_t, ctkwhile, ctknextline, ctksafecall);
...
begin
  ...
  case HashKey of
    ...
    827:
      begin
        if aToken = '__dispid' then Result := ctk__dispid else
          if aToken = 'safecall' then Result := ctksafecall;
      end;
